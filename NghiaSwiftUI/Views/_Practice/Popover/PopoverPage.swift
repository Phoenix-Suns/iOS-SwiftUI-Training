...
//  NghiaSwiftUI
//
//  Created by Nghia Tran on 1/11/24.
//
...
struct PopoverPage: View {
    ...
    var body: some View {
        ...
        .alwaysPopover(isPresented: $isShowingPopover, permittedArrowDirections: [.up, .down]) {
            Text("Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam")
                .font(.subheadline)
                .multilineTextAlignment(.center)
                .padding()
                .frame(width: UIDevice.current.userInterfaceIdiom == .phone ? (UIScreen.main.bounds.width - 16 * 2) : 350)
